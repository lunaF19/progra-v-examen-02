<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarPersona.aspx.cs" Inherits="Examen02_PrograV.Pages.EditarPersona" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section>
        ...
        <section id="filedsSection" runat="server">
            <br />
            <%-- 
                3.4.1. 
        ...
        <asp:Button ID="btnSave" runat="server" BackColor="Blue" ForeColor="White" Text="Guardar" OnClick="btnSave_Click" />
        <asp:Button ID="btnDelete" runat="server" BackColor="Red" ForeColor="White" Text="Eliminar" OnClick="btnDelete_Click" />
